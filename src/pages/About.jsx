        ...
        <div className="max-w-6xl mx-auto px-6 text-center space-y-12 relative z-10">
          ...
          >
            <div className="flex items-center justify-center space-x-4 mb-8">
              ...
              <img src="/images/about/daun.svg" alt="Daun Logo" className="h-12 w-auto opacity-80" />
            </div>
                ...
                <div className="flex items-start space-x-4 relative z-10">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3 flex items-center">
                      THE GOAL
                      <img src="/images/about/daun.svg" alt="Daun Logo" className="h-6 w-auto ml-3 opacity-60" />
                    </h3>
                    <div className="space-y-3">
                      <h4 className="font-semibold text-green-700 text-lg">VISI</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Menjadi perusahaan pengembang property yang profesional &
                        terpercaya yang dapat memberikan kontribusi untuk mengembangkan
                        daerah khususnya Batam & sekitarnya, dengan mengedepankan konsep
